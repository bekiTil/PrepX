...
import {createQuestions} from '../backend-utils/questions-utils'
...
const Page: React.FC = () => {
  ...
  const onSubmitHandle =()=>{
    ...
    createQuestions('df',questionList)
    .then((res) => res.json())
    .then((data)=>{
  ...
  return (
    <div>
      ...
      />
        ...
        >
          <Button disabled={!isFormValid || loading} onClick={handleSaveAndContinue} color="primary" variant="contained" type="submit">
            Save and Continue 
          </Button>
